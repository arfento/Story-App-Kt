...
import com.pinto.storyappkt.databinding.CardStoryLoadingBinding

class StoriesLoadingAdapter(private val retry : () -> Unit) : LoadStateAdapter<StoriesLoadingAdapter.LoadingStateViewHolder>() {
